...
class NoPackage2(google.protobuf.message.Message):
    ...
    _HasFieldNamesType: typing_extensions.TypeAlias = typing.Literal["np", b"np"]
    def HasField(self, field_name: _HasFieldNamesType) -> builtins.bool: ...
    _ClearFieldNamesType: typing_extensions.TypeAlias = typing.Literal["np", b"np", "np_rep", b"np_rep"]
