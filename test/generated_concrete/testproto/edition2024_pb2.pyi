...
class Editions2024SubMessage(google.protobuf.message.Message):
    ...
    _HasFieldNamesType: typing_extensions.TypeAlias = typing.Literal["thing", b"thing"]
    def HasField(self, field_name: _HasFieldNamesType) -> builtins.bool: ...
    _ClearFieldNamesType: typing_extensions.TypeAlias = typing.Literal["thing", b"thing"]
...
class Editions2024Test(google.protobuf.message.Message):
    ...
    _HasFieldNamesType: typing_extensions.TypeAlias = typing.Literal["default_singular", b"default_singular", "explicit_singular", b"explicit_singular", "legacy", b"legacy", "message_field", b"message_field"]
    def HasField(self, field_name: _HasFieldNamesType) -> builtins.bool: ...
    _ClearFieldNamesType: typing_extensions.TypeAlias = typing.Literal["default_singular", b"default_singular", "explicit_singular", b"explicit_singular", "implicit_singular", b"implicit_singular", "legacy", b"legacy", "message_field", b"message_field"]
    def ClearField(self, field_name: _ClearFieldNamesType) -> None: ...
