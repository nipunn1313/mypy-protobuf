...
(
    ...
    test "$(protoc-gen-mypy -V)" = "mypy-protobuf 5.1.0"
    test "$(protoc-gen-mypy --version)" = "mypy-protobuf 5.1.0"
    test "$(protoc-gen-mypy_grpc -V)" = "mypy-protobuf 5.1.0"
    test "$(protoc-gen-mypy_grpc --version)" = "mypy-protobuf 5.1.0"
