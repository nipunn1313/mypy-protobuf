...
(
    ...
    test "$(protoc-gen-mypy -V)" = "mypy-protobuf 2.10"
    test "$(protoc-gen-mypy --version)" = "mypy-protobuf 2.10"
    test "$(protoc-gen-mypy_grpc -V)" = "mypy-protobuf 2.10"
    test "$(protoc-gen-mypy_grpc --version)" = "mypy-protobuf 2.10"
